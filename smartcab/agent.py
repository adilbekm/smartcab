...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = self.epsilon * (0.9999 ** self.trial)
    ...
    def get_maxQ(self, state):
        ...
        a_space = self.Q[state]
        max_a = max(a_space.keys(), key=(lambda k: a_space[k]))
        maxQ = self.Q[state][max_a]
...
def run():
    ...
    sim.run(tolerance=0.02, n_test=25)
